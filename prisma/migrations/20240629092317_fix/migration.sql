/*
  ...
  - The values [AM,PM] on the enum `ResponseEnum` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "ResponseEnum_new" AS ENUM ('Yes', 'No', 'Maybe');
